...
This repository contains the translation and has been mathematically/statistically validated of the reference open-source controller ROSCO (Reference Open-Source Controller) from NREL https://www.nlr.gov/ (new link) (National Renewable Energy Laboratory), implemented entirely in SCL language (Structured Control Language)
